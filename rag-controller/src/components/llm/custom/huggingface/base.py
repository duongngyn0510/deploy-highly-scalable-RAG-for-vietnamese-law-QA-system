...
class HuggingFaceLLM(CustomLLM):
    ...
    def __init__(
        ...
        self._model = model or AutoModelForSeq2SeqLM.from_pretrained(
    ...
    def complete(
        ...
        inputs = self._tokenizer(full_prompt, return_tensors="pt", padding=True).input_ids
        ...
        completion = self._tokenizer.batch_decode(tokens, skip_special_tokens=True)
