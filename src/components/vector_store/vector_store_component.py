...
class VectorStoreComponent:
    ...
    def get_hybrid_retriever_v1(
        ...
        try:
            from src.components.vector_store.custom.retriever import HybridRetrieverV1

            return HybridRetrieverV1(
                index=index,
                similarity_top_k=similarity_top_k,
            ...
            raise ImportError(
                "Please implement HybridRetrieverV1 or import other custom Retriever"
            ) from e
    ...
    def get_hybrid_retriever_v2(
        ...
        try:
            ...
            raise ImportError(
                "Please implement HybridRetrieverV2 or import other custom Retriever"
            ) from e
