...
class DefaultPromptStyle(AbstractPromptStyle):
    ...
    def _messages_to_prompt(
        self, messages: Sequence[ChatMessage], system_prompt: Optional[str] = None
    ) -> str:
        ...
        if messages[0].role == MessageRole.SYSTEM:
            ...
            system_message_str = system_prompt or self.DEFAULT_SYSTEM_PROMPT
    ...
    def _completion_to_prompt(
        self, completion: str, system_prompt: Optional[str] = None
    ) -> str:
        system_prompt_str = system_prompt or self.DEFAULT_SYSTEM_PROMPT
